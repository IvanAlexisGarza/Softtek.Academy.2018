namespace Softtek.Academy2018.ToDoListApp.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Softtek.Academy2018.ToDoListApp.Data.ToDoListContext>
    {
        ...
        protected override void Seed(Softtek.Academy2018.ToDoListApp.Data.ToDoListContext context)
        {
            ...
            context.Tag.Add(new Domain.Model.Tag { Id = 1, Name = "Groceries", CreatedDate = DateTime.Now, ModifiedDate = null });
            context.Tag.Add(new Domain.Model.Tag { Id = 2, Name = "Bills", CreatedDate = DateTime.Now, ModifiedDate = null });
            context.Tag.Add(new Domain.Model.Tag { Id = 3, Name = "University", CreatedDate = DateTime.Now, ModifiedDate = null });
            context.Tag.Add(new Domain.Model.Tag { Id = 4, Name = "Friends", CreatedDate = DateTime.Now, ModifiedDate = null });
            context.Tag.Add(new Domain.Model.Tag { Id = 5, Name = "Family", CreatedDate = DateTime.Now, ModifiedDate = null });
            context.Tag.Add(new Domain.Model.Tag { Id = 6, Name = "Personal", CreatedDate = DateTime.Now, ModifiedDate = null });
        }
    }
}
